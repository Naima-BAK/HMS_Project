...
public class AjouterEmployé extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(273, 410, -1, -1));
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 190, -1, 40));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 10, 80, 50));

        jButton6.setBackground(new java.awt.Color(255, 204, 0));
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Client/Close.png"))); // NOI18N
        jButton6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton6ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 10, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            if(jTextField1.getText().equals("") || jTextField2.getText().equals("") || jTextField3.getText().equals("") || jTextField4.getText().equals("") || jTextField5.getText().equals("") || jTextField6.getText().equals("") || jComboBox1.equals("")|| jComboBox2.equals("")  ){
            ...
            else
            {
                ...
                while(rs.next()){
                    //id=rs.getInt(1);
                    //id=id+1;
                    Query="insert into Employee(id,name,mobileNumber,age,gender,job,salary,email,address) values ('"+ID+"','"+name+"','"+mobileNumber+"','"+age+"','"+gender+"','"+job+"','"+salary+"','"+email+"','"+address+"')";
                    InsertUpdateDelete.setData(Query, "l'employé est enregistrer avec succés");
                    setVisible(false);
