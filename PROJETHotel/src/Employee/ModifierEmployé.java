 ...
 */
public class ModifierEmployé extends javax.swing.JFrame {

    /**
     * Creates new form ModifierEmployé
     */
    ...
    private void initComponents() {
        ...
        setLocation(new java.awt.Point(119, 144));
        setUndecorated(true);
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Employee/3592869-compose-create-edit-edit-file-office-pencil-writing-creative_107746.png"))); // NOI18N
        ...
        jLabel1.setText("Modifier les informations d'employé");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            stmt.execute("update employee set name='"+name+"',mobileNumber='"+mobileNumber+"',age='"+age+"',gender='"+gender+"',job='"+job+"',salary='"+salary+"',email='"+email+"',address='"+address+"' where id='"+ID+"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModifierEmployé.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
