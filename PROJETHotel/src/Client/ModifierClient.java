...
public class ModifierClient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Modifier Un Client");
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 403, 90, 50));
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Client/search.png"))); // NOI18N
        jButton3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton3ActionPerformed(evt);
            }
        });
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 60, 80, 50));

        jButton1.setBackground(new java.awt.Color(0, 0, 0));
        jButton1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jButton1.setForeground(new java.awt.Color(255, 255, 255));
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Client/update.png"))); // NOI18N
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1ActionPerformed(evt);
            }
        });
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 400, 100, 49));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        new MediaPlayer(new Media(uri1)).play();
            ...
            stmt.execute("update Client set name='"+name+"',mobileNumber='"+mobileNumber+"',nationality='"+nationality+"',gender='"+gender+"',identityCode='"+identityCode+"',email='"+email+"',address='"+address+"' where id='"+ID+"'");
            JOptionPane.showMessageDialog(null, "Le client est Modifier avec succés");
            setVisible(false);
            new ModifierClient().setVisible(true);
        }}
